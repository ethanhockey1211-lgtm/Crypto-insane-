...
import type { CandleClosed, FeedStatus, QuoteDto, ScannerStream, TapeEvent } from "./types";
...
async function refresh(): Promise<void> {
  const [scanner, feed, tape] = await Promise.allSettled([api.scanner(), api.feed(), api.tape(100)]);
